# Historical topic catalog

Preserved from the original README for reference. This broad catalog has not been fully reviewed for accuracy; use the guided exercises in the root README as your starting point.
